...
EVENT_BATCH_SIZE = env.int("EVENT_BATCH_SIZE", default=1000)
EVENT_PROCESSING_INTERVAL = env.int("EVENT_PROCESSING_INTERVAL", default=60)
CLICKHOUSE_BATCH_SIZE = env.int("CLICKHOUSE_BATCH_SIZE", default=10000)